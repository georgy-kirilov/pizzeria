...
namespace Pizzeria.Api.Menu.Database.Seeding;

public static class PizzaDataSeeder
{
    public static async Task Seed(MenuDbContext db)
    {
        if (await db.Pizzas.AnyAsync())
        {
            return;
        }

        var cheese = new PizzaIngredientType { Name = "Cheese" };
        var sauce = new PizzaIngredientType { Name = "Sauce" };
        var meat = new PizzaIngredientType { Name = "Meat" };
        var veggies = new PizzaIngredientType { Name = "Veggies" };
        var spices = new PizzaIngredientType { Name = "Spices" };

        var small = new PizzaSize { Name = "Small", Slices = 6 };
        var medium = new PizzaSize { Name = "Medium", Slices = 8 };
        var large = new PizzaSize { Name = "Large", Slices = 10 };
        var jumbo = new PizzaSize { Name = "Jumbo", Slices = 12 };

        var allPizzaIngredients = new PizzaIngredient[]
        {
            new()
            {
                Name = "Mozzarella",
        ...
        var allPizzaIngredientTypes = new PizzaIngredientType[]
        {
            cheese,
            sauce,
            meat,
        ...
        var allPizzaSizes = new PizzaSize[]
        {
            small,
            medium,
            large,
        ...
        var allPizzaDoughs = new PizzaDough[]
        {
        ...
        var pizzaNamesToSeed = new HashSet<string>
        {
            "Margherita",
            "Pepperoni",
            "Sicilian",
        ...
        {
            var pizza = new Pizza { Name = pizzaName };
